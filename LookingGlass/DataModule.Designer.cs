namespace LookingGlass
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            // oleDbSelectCommand1
            // 
            this.oleDbSelectCommand1.CommandText = "SELECT VacancyID, CandidateID, ApplicationDate\r\nFROM     APPLICATION\r\nORDER BY Va" +
    "cancyID";
            this.oleDbSelectCommand1.Connection = this.oleDbConnection2;
            // 
            // oleDbConnection2
            // 
            this.oleDbConnection2.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Temp\\LookingGlass.mdb";
            this.oleDbConnection2.InfoMessage += new System.Data.OleDb.OleDbInfoMessageEventHandler(this.oleDbConnection2_InfoMessage);
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `APPLICATION` (`VacancyID`, `CandidateID`, `ApplicationDate`) VALUES " +
    "(?, ?, ?)";
            ...
            new System.Data.OleDb.OleDbParameter("ApplicationDate", System.Data.OleDb.OleDbType.Date, 0, "ApplicationDate")});
            // 
            // oleDbUpdateCommand1
            // 
            ...
            new System.Data.OleDb.OleDbParameter("IsNull_ApplicationDate", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ApplicationDate", System.Data.DataRowVersion.Original, true, null),
            new System.Data.OleDb.OleDbParameter("Original_ApplicationDate", System.Data.OleDb.OleDbType.Date, 0, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "ApplicationDate", System.Data.DataRowVersion.Original, null)});
            // 
            // oleDbDeleteCommand1
            // 
            this.oleDbDeleteCommand1.CommandText = "DELETE FROM `APPLICATION` WHERE ((`VacancyID` = ?) AND (`CandidateID` = ?) AND ((" +
    "? = 1 AND `ApplicationDate` IS NULL) OR (`ApplicationDate` = ?)))";
            ...
            this.daApplication.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.oleDbDataAdapter1_RowUpdated);
            // 
            // oleDbSelectCommand2
            // 
            this.oleDbSelectCommand2.CommandText = "SELECT CandidateID, LastName, FirstName, StreetAddress, Suburb, PhoneNumber, Gend" +
    ...
    " OR (`Description` = ?)))";
            ...
            this.daSkill.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daSkill_RowUpdated);
            // 
            // oleDbSelectCommand6
            // 
